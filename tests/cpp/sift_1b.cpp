...
void sift_test1B() {
    ...
    const char *path_gt = "/home/zqy/Downloads/bigann-100M";
    const char *path_q = "/home/zqy/Downloads/sift100M_query.u8bin";
    const char *path_data = "/home/zqy/Downloads/sift100M_base.u8bin";
    snprintf(path_index, sizeof(path_index), "sift1b_%dm_ef_%d_M_%d.bin", subset_size_milllions, efConstruction, M);

    //snprintf(path_gt, sizeof(path_gt), "/home/zqy/Downloads/sift100M_groundtruth.bin", subset_size_milllions);
